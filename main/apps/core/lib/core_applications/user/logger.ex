defmodule Core.CoreApplications.User.Logger do
  ...
  defp connect_to_remote_node do
    Node.connect(Application.get_env(:logger_user_service, :remote_node))
  end

  defp send_to_loger_service(type, from_node, message) do
    Task.Supervisor.async(
      Application.get_env(:logger_user_service, :remote_supervisor),
      Application.get_env(:logger_user_service, :remote_module),
      :log,
