...
config :user_http_registrating_service, UserHttpRegistratingServiceWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: false,
  render_errors: [view: UserHttpRegistratingServiceWeb.ErrorView, accepts: ~w(json)],
  secret_key_base: "jVX1BHrTqu3uWQfoIodYYfwvbAYE2KL13I+3vvoHx9rJJbmlBBhSRfkMi0uvfNLl",
  watchers: []
